...
# It is an open sourse AI library used to create large scale neural networks with many layers
...
from os import path
# Utils is the collection of small python functions and classes
from utils import label_map_util
from utils import visualization_utils as vis_util
import time
import cv2  # It is used for computer vision purpose

# It allows us to use any version of tensor flow into program
...
Num_images = 1
PATH_TO_TEST_IMAGES_DIR = p+'/static/test_images'
MODEL_NAME = 'faster_rcnn_resnet101_coco_11_06_2017'


def detect_traffic_lights(plot_flag=False):
    """
    ...
    PATH_TO_LABELS = p+'/static/mscoco_label_map.pbtxt'
        ...
        with tf.Session(graph=detection_graph) as sess:
            ...
            for image_path in TEST_IMAGE_PATHS:
                ...
                if stop_flag:
                    ...
                    # Send the output as a response + image
                    # tts("")
                    return "Please don't cross the road Now"
                    ...
                    return "Now you can cross the road safely"
